...
function CompanyResetPasswordContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/reset-password", {
        ...
        body: JSON.stringify({ token, password, type: "company" }),
      });
        ...
        <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700 rounded-xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Şirket hesabınız için yeni bir şifre belirleyin
            </p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    minLength={8}
                    className="w-full px-4 py-3 bg-gray-900/50 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent pr-12"
